...
<section class="method"><div class="section-head"><div><span class="kicker">Evidence boundary</span><h2>真实证据和情境演示，分开说</h2></div></div><p class="disclosure">上方 12 个案例是为解释单一风险而制作的可控演示，不伪装成客户案例；公开的当前版 83 → 100 Proof Loop 才是可下载、可复核的真实九页 PPTX 改造证据。旧版 49 分是 v0.3 历史评分，不再作为当前结果。</p></section>
